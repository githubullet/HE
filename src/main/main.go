...
func main() {
	...
	img := bmpRead("/Users/sueyang/Desktop/Code/Single_key_CKKS/lattigo_ckks_edit_v4/src/main/linux150x150.bmp")
	...
	fmt.Printf("Homomorphic Addition	: %8d μs\n", end-start)
	...
	bmpWrite("linux150x150_2.bmp", afterImage)
	bmpWrite("linux150x150_3.bmp", img)

	afterPixel1 := convertToGray(bmpRead("linux150x150_2.bmp"))
	afterPixel2 := convertToGray(bmpRead("linux150x150_3.bmp"))

	if compareImages(afterPixel1, afterPixel2) {
		fmt.Println("linux150x150_2.bmp and linux150x150_3.bmp are similar")
	} else {
		fmt.Println("lena50x50_2.bmp and lena50x50_3.bmp are not similar")
	}
}
